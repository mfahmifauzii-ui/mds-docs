export default function DoDontCard({
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div className="overflow-hidden rounded-xl border border-[var(--mds-neutral-100)]">
        <div className="mds-checker flex min-h-[120px] items-center justify-center p-6">{doExample}</div>
        <div className="border-t border-[var(--mds-neutral-100)] p-4">
          ...
          <p className="text-[13px] leading-5 text-[var(--mds-neutral-500)]">{doText}</p>
        </div>
      </div>
      <div className="overflow-hidden rounded-xl border border-[var(--mds-neutral-100)]">
        ...
        <div className="border-t border-[var(--mds-neutral-100)] p-4">
          ...
          <p className="text-[13px] leading-5 text-[var(--mds-neutral-500)]">{dontText}</p>
        </div>
      </div>
    </div>
  );
